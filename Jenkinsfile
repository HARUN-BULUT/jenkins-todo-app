pipeline{
    ...
    post {
        ...
        success {
             script {
             slackSend(channel: '#student-zone', color: '#439FE0', message: 'Show must go on: https://www.youtube.com/watch?v=fLsaH_FHmN8&ab_channel=VDev', teamDomain: 'devops16tr', tokenCredentialId: 'jenkns-for-slack')
                }
         }
